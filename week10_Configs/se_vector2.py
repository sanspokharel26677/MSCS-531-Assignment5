...
process = Process()
process.executable = "/media/sandesh/easystore1/Sandesh_CumberLands_Assignments/Computer_Architecture/Week2/gem5/array_add_vector"  # Update with vector addition binary path
